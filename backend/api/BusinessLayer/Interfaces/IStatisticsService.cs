...
public interface IStatisticsService
{
    ...
    public Task<Result<bool>> DeleteUserStatisticsAsync(Guid userId);
    public Task RecalculateUserStatisticsAsync(Guid userId);
    ...
    public Task<Result<bool>> DeleteDailyStatisticsAsync(Guid userId, DateOnly date);
    public Task<Result<bool>> DeleteDailyStatisticsAsync(Guid statisticId);
    public Task RecalculateDailyStatisticsAsync(Guid userId, DateOnly date);
    ...
    public Task<Result<ExistDto>> ExerciseStatisticsExistAsync(Guid userId, Guid exerciseId);
}