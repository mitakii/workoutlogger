...
{
    public Task<Result<bool>> ApplyTemplateAsync(string userLanguage, Guid workoutId, Guid templateWorkoutId);
    public Task<Result<TemplateGetResponse>> GetTemplateAsync(Guid templateId, string language);
